...
> 2026-04-24 实测总结 | 环境: Windows + Python 3.12
...
```yaml
settings:
  proxy: "http://your-proxy:port"   # ← 海外Provider需代理（Gemini/OpenAI/Groq/Anthropic）

profiles:
  gemini_main:
    api_key: "your-api-key"           # ← 必填！你的Key
...
# 方法2：代码里传参
client = LLMClient(..., proxy="http://your-proxy:port")
...
```yaml
default_model: ""                     # 留空=自动选择

settings:
  proxy: "http://your-proxy:port"       # ← 改成你的代理地址（海外Provider需要）
